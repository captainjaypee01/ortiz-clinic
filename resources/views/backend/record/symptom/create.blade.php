...
@section('title', 'Symptom Management' . ' | ' . 'Create Symptom')

@section('content')
{{ html()->form('POST', route('admin.record.symptom.store'))->class('form-horizontal')->open() }}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        Symptom Management
                        <small class="text-muted">Create Symptom</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->
